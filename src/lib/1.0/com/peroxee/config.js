window.Peroxee = !document.location.host.match(/local/) ? 
{
  config:{
    appHost: window.location.hostname,
    debug: true,
//    serviceHost: "dev.api.roxee.net:4242",
    serviceHost: "api.roxee.net",
...
// Peroxee.config.serviceHost = "dev.api.roxee.net:4242";
